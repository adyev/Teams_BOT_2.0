...
def set_users():
    with open ('Data/Users/adyevdv@sovcombank.ru.pickle', 'wb') as f:
        pickle.dump(User(chat_id='adyevdv@sovcombank.ru', name='Адыев Дмитрий Владимирович', birth_date=datetime.date(1999, 8, 7)), f)
    with open ('Data/Users/barancheevai@sovcombank.ru.pickle', 'wb') as f:
        pickle.dump(User(chat_id='barancheevai@sovcombank.ru', name='Баранчеев Андрей Игоревич', birth_date=datetime.date(1981, 1, 10)), f)
    ...
    with open ('Data/Users/emelyanovaov@sovcombank.ru.pickle', 'wb') as f:
        pickle.dump(User(chat_id='emelyanovaov@sovcombank.ru', name='Емельянова Олеся Витальевна', birth_date=datetime.date(2001, 4, 1)), f)
    ...
    with open ('Data/Users/lipniksg@sovcombank.ru.pickle', 'wb') as f:
        pickle.dump(User(chat_id='lipniksg@sovcombank.ru', name='Липник Сергей Геннадьевич', birth_date=datetime.date(1991, 8, 21), time_zone=7, city='Хабаровск'), f)
    ...
    with open ('Data/Users/ryzhovaa@sovcombank.ru.pickle', 'wb') as f:
        pickle.dump(User(chat_id='ryzhovaa@sovcombank.ru', name='Рыжов Артем Андреевич', birth_date=datetime.date(1993, 9, 24)), f)
    ...
    with open ('Data/Users/steganovaka@sovcombank.ru.pickle', 'wb') as f:
        pickle.dump(User(chat_id='steganovaka@sovcombank.ru', name='Стеганова Ксения Алексеевна', birth_date=datetime.date(2001, 10, 26), time_zone=1, city='Саратов'), f)
